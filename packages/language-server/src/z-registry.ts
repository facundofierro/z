...
// Define types locally since we're not using a package
...
export interface Registry {
    ...
    annotations: Record<string, AnnotationInfo>;
...
export function loadRegistry(): Registry {
    ...
    // Try to find shared registry.json from various locations
    const possiblePaths = [
        // Relative to workspace root
        './shared/registry.json',
        // Relative to LSP directory
        '../../shared/registry.json',
        // Fallback to old compiler location for compatibility
    ...
    throw new Error('Could not load Z language registry from shared location');
}
